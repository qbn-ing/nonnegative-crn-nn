...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run paired m=3/m=4 Chebyshev I-by-C experiments."
    )
    ...
    parser.add_argument(
        "--output-root", type=Path, default=Path("runs") / "chebyshev"
    )
